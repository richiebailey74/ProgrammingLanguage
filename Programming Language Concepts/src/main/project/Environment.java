...
public final class Environment {
    ...
    //creates PlcObject in a null scope (scope defining must be done explicitly)
    ...
    //gets the type from the string name from the defined hash map
    ...
    //allows for particular types to be created for our language and are used throughout our program, most useful in the analyzer and parser for type validation
    ...
    //allows for PLC objects to be made so that the interpreter can return meaningful (calculated/evaluated) data
    ...
    //Variable class allows for Environment.Variable objects to be made and their subsequent functionality of storing variable data so that storing in scopes is easier
    ...
    //Function class allows for Environment.Function objects to be made and their subsequent functionality of storing function data so that storing in scopes is easier
    ...
    static {
        ...
        Type.STRING.scope.defineVariable("length", "length()", Type.INTEGER, true, Environment.NIL);
